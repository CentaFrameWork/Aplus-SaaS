...
#define AddEntrustFiling 1  // 新增外出
#define EditEntrustFiling 2 // 编辑外出

/// 新增备案
@interface EntrustFilingAddApi : APlusBaseApi
...
@property (nonatomic,assign) NSInteger commitEntrustfilingType;

@end

@interface Attachments : APlusBaseApi

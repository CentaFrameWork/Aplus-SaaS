...
/** 设置密码提示文字 */
NSString *const CoreLockPWDTitleFirst = @"请滑动绘制解锁图案";



/** 设置密码提示文字：确认 */
NSString *const CoreLockPWDTitleConfirm = @"请再次绘制解锁图案";


/** 设置密码提示文字：再次密码不一致 */
NSString *const CoreLockPWDDiffTitle = @"与上次绘制不一致,请重新绘制";
...
/** 验证密码：密码错误次数达到上限 */
NSString *const CoreLockVerifyErrorLimitTitle = @"输入次数达到上限";

...
-(void)circleNormal:(CGContextRef)ctx rect:(CGRect)rect{
    
    {
        ...
        //添加一个圆环路径
        CGPathAddEllipseInRect(loopPath, NULL, self.calRect);
    ...
    //新增代码
    {
        ...
        //绘制一个圆形
        CGPathAddEllipseInRect(loopPath, NULL, self.selectedRect);
...
-(void)circleSelected:(CGContextRef)ctx rect:(CGRect)rect{
    ...
    
    {
        ...
        //设置填充颜色
        UIColor * color = CoreLockCircleLineSelectedCircleColor;

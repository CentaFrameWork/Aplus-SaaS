...
@interface ChannelCustomerVC ()<BJTurnPrivateDelegate>
{
...
@implementation ChannelCustomerVC
...
- (void)initView
{
    ...
    // 创建顶部搜索框
    _searchTextfield = [self createTextfieldWithPlaceholder:@"原归属人或公共池" andHaveRightBtn:YES];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [NewUtils popoverSelectorTitle:nil listArray:listArr theOption:^(NSInteger optionValue) {
        ...
        [weakSelf funcWithIndex:optionValue];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ChannelCallModelEntity *channelCustomerEntity = _tableViewSource[row];
    ...
    channelCustomersTableViewCell.phoneAddressInfo = phoneInfo;
    channelCustomersTableViewCell.channelCallModelEntity = channelCustomerEntity;
...
//    {
        ...
        turnPrivateCustomerViewController.isMyPayChannelInquiry = channelCustomer.isMyPayChannelInquiry;
        turnPrivateCustomerViewController.delegate = self;
        [self.navigationController pushViewController:turnPrivateCustomerViewController animated:YES];
//    }
//    else
//    {
...
#pragma mark - private
- (void)funcWithIndex:(NSInteger)index{

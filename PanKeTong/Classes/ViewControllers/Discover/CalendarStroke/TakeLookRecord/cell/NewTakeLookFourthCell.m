...
@implementation NewTakeLookFourthCell
...
+ (NewTakeLookFourthCell *)cellWithTableView:(UITableView *)tableView{
    ...
    NewTakeLookFourthCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass(self)];

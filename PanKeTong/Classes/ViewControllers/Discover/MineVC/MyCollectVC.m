...
@interface MyCollectVC ()<UITableViewDataSource,UITableViewDelegate,FilterViewDelegate,ButtonClickDelegate,MoreFilterInfoDelegate,AllRoundListViewProtocol,
...
//            allRoundDetailVC.propEstateName = [NSString stringWithFormat:@"%@",propModelEntity.estateName];

...
@property (strong, nonatomic)SelectPickerView *pickerView;
...
- (instancetype)init
{
    if (self = [super initWithFrame:[[UIScreen mainScreen] bounds]]) {
        ...
        //时间选择View
        _pickerView = [[NSBundle mainBundle] loadNibNamed:NSStringFromClass([SelectPickerView class]) owner:self options:nil].lastObject;
